...
public final class Icons {
    ...
    private static final Map<String, String> PATHS = Map.ofEntries(
            ...
            Map.entry("history", "M13 3c-4.97 0-9 4.03-9 9H1l4 4 4-4H6c0-3.86 3.14-7 7-7s7 3.14 7 7-3.14 7-7 7c-1.93 0-3.68-.79-4.95-2.05l-1.42 1.42A8.94 8.94 0 0 0 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-.5 5v5.25l4.5 2.67 1-1.64-3.5-2.03V8h-2z"),
            Map.entry("undo", "M12.5 8c-2.65 0-5.03 1.08-6.75 2.82V7H4v7h7v-1.75H6.79A7.47 7.47 0 0 1 12.5 10c2.59 0 4.82 1.32 5.96 3.25l1.68-.99A8.98 8.98 0 0 0 12.5 8z"),
            Map.entry("redo", "M11.5 8a8.98 8.98 0 0 0-7.64 4.26l1.68.99A6.97 6.97 0 0 1 11.5 10c2.2 0 4.22.99 5.71 2.25H13V14h7V7h-1.75v3.82A9.47 9.47 0 0 0 11.5 8z"),
            Map.entry("history-restore", "M13 3c-4.97 0-9 4.03-9 9H1l4 4 4-4H6c0-3.86 3.14-7 7-7s7 3.14 7 7-3.14 7-7 7c-1.93 0-3.68-.79-4.95-2.05l-1.42 1.42A8.94 8.94 0 0 0 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9z"),
